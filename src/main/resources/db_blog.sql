...
CREATE TABLE `t_album` (
  ...
  `summary` VARCHAR(400) DEFAULT NULL COMMENT '简介',
  `releaseDate` DATETIME DEFAULT NULL COMMENT '发布日期',
  `albumPhoto` VARCHAR(60) DEFAULT NULL COMMENT '相册缩略图',
  `reserve1` VARCHAR(60) DEFAULT NULL COMMENT '预留字段1',
  `reserve2` VARCHAR(60) DEFAULT NULL COMMENT '预留字段2',
  `reserve3` VARCHAR(60) DEFAULT NULL COMMENT '预留字段3',
  PRIMARY KEY (`id`)
) ENGINE=INNODB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

CREATE TABLE `t_pictures` (
  `id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '图片id',
   `picture_name` VARCHAR(60) DEFAULT NULL COMMENT '相册缩略图',
  `album_id` INT(11) DEFAULT NULL COMMENT '图片所属相册',
  `orderNum` INT(11) DEFAULT NULL COMMENT '图片排序',
  `height` float(11) DEFAULT NULL COMMENT '图片高度',
  `width` float(11) DEFAULT NULL COMMENT '图片宽度',
  `releaseDate` DATETIME DEFAULT NULL COMMENT '发布日期',
  ...
  CONSTRAINT `t_pictures_ibfk_1` FOREIGN KEY (`album_id`) REFERENCES `t_album` (`id`)
) ENGINE=INNODB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
